...
#define PROTECTED_RANGE_VENDOR_HASH_PHOENIX       0x03
#define PROTECTED_RANGE_VENDOR_HASH_AMI_OLD       0x04
#define PROTECTED_RANGE_VENDOR_HASH_AMI_NEW       0x05
#define PROTECTED_RANGE_VENDOR_HASH_MICROSOFT     0x06

...
const UByteArray INTEL_FIT_SIGNATURE("\x5F\x46\x49\x54\x5F\x20\x20\x20", 8);
...
// ChecksumValid bit must be 0
// TODO: find an image with it or reverse the ACM enough to see how Address looks like
